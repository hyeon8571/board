...
//        return (web -> web.ignoring().requestMatchers(PathRequest.toStaticResources().atCommonLocations())); // spring security 검사에서 제외하겠다는 의미, PathRequest.toStaticResources().atCommonLocations()) -> 미리 자주 쓰는 것들을 시큐리티에서 정해 놓은걸 사용
//    } // 권장 되지 않는 방법, 위가 더 좋은 방법
